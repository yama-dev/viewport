class TOP {
	...
	Init(){
		...
		$('.modal__menu_list,.modal__menu_list_bg').css('height',this.DocH);
		$('.modal__contact,.modal__contact_bg').css('height',this.DocH);
		$('.modal__site_use,.modal__site_use_bg').css('height',this.DocH);
	}
	SpInit(){
		var _that = this;
...
$(window).on('load',function(){
	setTimeout(function(){Top.SetWidget()},1500);
	setTimeout(function(){Top.TopSlider()},1500);
});
